...
def _dataset_card(version: str, manifest: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            "",
            "This artifact combines the processed theorem-disjoint ID splits with LLM-generated theorem semantic and strategy enrichment.",
            "",
            "## Contents",
            "",
            ...
            *split_lines,
            ...
            "## Intended Use",
            "",
            "Use this dataset for Proof-State -> Premise retrieval, Theorem -> Theorem pattern retrieval, and similar-theorem guidance aggregation under the same ID split assumption as the processed source data.",
            "",
        ]
    )
    ...
    return "\n".join(
        [
            ...
            *configs,
            ...
            f"# ProofAtlas Enriched Dataset {version}",
            "",
            "ProofAtlas Enriched combines theorem-disjoint Lean retrieval splits with LLM-generated theorem semantic and strategy enrichment.",
            "",
            "## Source Data",
            "",
            ...
            "- remaining configs contain processed feature and technique tables.",
            "",
            "## Split Summary",
            "",
            "| Split | Theorems | Proof states | Premises | Positive edges | LLM enriched theorems | LLM coverage |",
            ...
            *split_lines,
            ...
            "- Similar-theorem guidance aggregation.",
